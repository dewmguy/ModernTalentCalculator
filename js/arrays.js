...
if(urltalents) {
 console.log("decompressed url: " + decompress(urltalents));
 urltalents = decompress(urltalents);
}

for(e=0; e < urltalents.length; e++) { saveTemplate[e] = urltalents.charAt(e); }
...
while(tierLoop < tierNum) {
 for(var treeLoop = 0; treeLoop < numberOfTrees; treeLoop++) { pointsTier[treeLoop][tierLoop] = 0; }
 tierLoop++; 
}
tierLoop = 0;
